...
public class Robot extends TimedRobot {
    ...
    WPI_TalonFX [] _fxes =  { new WPI_TalonFX(13, "rio"), new WPI_TalonFX(14, "rio"),new WPI_TalonFX(1, "rio"), new WPI_TalonFX(2, "rio"),new WPI_TalonFX(3, "rio"), new WPI_TalonFX(4, "rio") };
