...
public class AutoPlaceMidCubeAndMoveNearLoadingZone extends SequentialCommandGroup {
  /** Creates a new AutoPlaceMidCubeAndMoveRight. */
  DriverStation.Alliance color = DriverStation.getAlliance();

  NewRunMotionProfile mp;

  public AutoPlaceMidCubeAndMoveNearLoadingZone(RobotOdometry odometry, Drive driveTrain) {
    ...
    // assume the right is the negative Y (robot front facing driver station)
    ...
    mp = new NewRunMotionProfile(driveTrain, odometry, new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(0), new Rotation2d()), 0,
        ...
        addCommands(
            ...
            new AutoPneumatics(1, 0.5),  // 4.8 seconds
            new ParallelCommandGroup(
