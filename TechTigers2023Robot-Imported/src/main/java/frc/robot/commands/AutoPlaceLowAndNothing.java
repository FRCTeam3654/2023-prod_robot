...
public class AutoPlaceLowAndNothing extends SequentialCommandGroup {
  /** Creates a new AutoStayStillCommand. */

  NewRunMotionProfile mp;
  public AutoPlaceLowAndNothing(RobotOdometry odometry, Drive driveTrain) {
   ...
   // mp = new NewRunMotionProfile(driveTrain, odometry, new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(0), new Rotation2d()), 0,
    ...
    addCommands(
      ...
      new ArmSetPositionsCommand(2000), new AutoWrist(1), /*new AutoPneumatics(1),*/ new AutoIntakeWheelsCommand(5), new AutoWrist(2), /*new AutoPneumatics(2)*/ new AutoIntakeWheelsCommand(0)
      //mp
    );
