...
multiplier = 1;
      ...
      addCommands(
            ...
            */
            ...
            /* 
            ,  // intake for 0.5 seconds with 0.25 intakeSpeed

            new ParallelCommandGroup(
              new AutoIntakeWheelsCommand(5), // spit out for 0.8 second with -0.8 intakSpeed
              new  SequentialCommandGroup(  
                new WaitCommand(0.4),
                new ParallelCommandGroup(
                  new AutoWrist(2), // raise wrist, 1.5 seconds,
                  //new AutoIntakeWheelsCommand(0), // stop
                  ...
                  //  mp1,
                  //  new AutoWrist(3), // lower wrist to shoot
                  //  new AutoIntakeWheelsCommand(2) // rely on its timeout 2 seconds
                  //)
