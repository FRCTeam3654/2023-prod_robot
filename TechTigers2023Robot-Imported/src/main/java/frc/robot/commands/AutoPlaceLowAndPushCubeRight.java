...
public class AutoPlaceLowAndPushCubeRight extends SequentialCommandGroup {
  ...
  public AutoPlaceLowAndPushCubeRight(RobotOdometry odometry, Drive driveTrain) {
    ...
    mp1 = new NewRunMotionProfile(driveTrain, odometry, new Pose2d(Units.inchesToMeters(-216), Units.inchesToMeters(31), new Rotation2d(-140)), 0,
        List.of(new Translation2d(Units.inchesToMeters(-209), Units.inchesToMeters(0)),
                new Translation2d(Units.inchesToMeters(-187), Units.inchesToMeters(-22)),
                new Translation2d(Units.inchesToMeters(-150), Units.inchesToMeters(15))
        
        ),
        new Pose2d(Units.inchesToMeters(-65), Units.inchesToMeters(15), Rotation2d.fromDegrees(0)), 1.3, false, false);
