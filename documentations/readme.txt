...
import frc.robot.commands.AutoArmSetPositionsCommand;
import frc.robot.commands.ManualArmCommand;
import frc.robot.commands.ArmJoustCommand;
import frc.robot.commands.AuotArmJoustCommand;
...
public class AutoPlaceMidAndPickAndDropNearLoadingZone extends SequentialCommandGroup {
  ...
  public AutoPlaceMidAndPickAndDropNearLoadingZone(RobotOdometry odometry, Drive driveTrain) {
...
multiplier = 1;
    ...
    new Pose2d(Units.inchesToMeters(0), Units.inchesToMeters(multiplier * (-20)), Rotation2d.fromDegrees(0)), 0, false, false);
