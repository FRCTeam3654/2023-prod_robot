...
public class NewRunMotionProfile extends CommandBase {
   ...
   *                         metric)
   */
  public NewRunMotionProfile(Drive driveTrain, RobotOdometry odometry, double initialVelocity,
   ...
   *                           be metric)
   */
  public NewRunMotionProfile(Drive driveTrain, RobotOdometry odometry, Pose2d initialPosition,
   ...
   *                           be metric)
   */
  public NewRunMotionProfile(Drive driveTrain, RobotOdometry odometry, List<Translation2d> intermediatePoints,
   ...
   *                           be metric)
   */
  private void setup(Drive driveTrain, RobotOdometry odometry, List<Translation2d> intermediatePoints,
      Pose2d endPosition, double endVelocity, boolean reversed, boolean relative,
      List<TrajectoryConstraint> extraConstraints) {
  ...
  public void startGeneration() {
    if (dynamicTrajectory) {
      startGeneration(getCurrentPoseMeters(),
          (driveTrain.getVelocityLeft() + driveTrain.getVelocityRight()) / 2);
    }
  }
